 ...
 * Use the {@link MainPage2#newInstance} factory method to
...
public class MainPage2 extends Fragment {
    ...
    public static MainPage2 newInstance(String param1, String param2) {
        MainPage2 fragment = new MainPage2();
...
//        });
        ...
        c1.setCourse_id(1);c1.setCourse_name("工程实践");
        c1.setTeacher("池芝标");c1.setTime("2020-2");
        data.add(c1);
        CoursesListBean c2 =new CoursesListBean();
        c2.setCourse_id(1);c2.setCourse_name("人工智能");
